    ...
    return (
      <div className={styles.container}>
        ...
        <Toaster />
          ...
          <div>
            <p style={{color: "#f8646c"}} className="text-2xl mb-2 text-center">Stay up to date with the latest</p>
            <p style={{color: "#f8646c"}} className="text-2xl mb-2 text-center">from the blog</p>
            <p className="text-center mb-4">Give us your email, we'll do the rest</p>
          </div>
          <input type="email" placeholder="Your email" onChange={(e)=> setBlogEmail(e.target.value)} name="email" value={blogEmail} className="px-11 py-3 mb-2 rounded bg-transparent text-base outline-0" style={{ border: "1px solid #f8646c"}}/>
