...
import { Paragraph, H1, Row, Text } from '@components'
    ...
    return (
      <NewsLetter>
        ...
        <Toaster />
          ...
          <div>
            <Paragraph style={{color: "#f8646c"}} size="lg" margin="0 0 0.3rem 0" align="center">Stay up to date with the latest</Paragraph>
